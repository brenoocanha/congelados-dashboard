    ...
    <>
      <div className="grid grid-cols-2 gap-2 w-full">
        <div className="w-full">
          <table className="w-full table-auto max-h-[50px]">
            <tbody className="flex w-full flex-col min-h-[calc(100vh-118px)] flex-grow ">
              {primeiraMetade.map((item, index) => (
                ...
                >
                  <td className="px-4 text-2xl font-black">{item.produto}</td>
                  <td className="px-4 w-full max-w-40 text-2xl font-black">{item.valor}</td>
                </tr>
              ))}
            </tbody>
          </table>
          ...
          <table className="w-full table-auto">
            <tbody className="flex w-full flex-col min-h-[calc(100vh-118px)] flex-grow">
              ...
              {!isEven && (
                ...
                >
                  <td className="px-4 text-2xl font-bold">XXXXXXXXXXXXXXXXXXXXXX</td>
                  <td className="px-4 w-full max-w-32 text-2xl font-bold">XXXXXX</td>
                </tr>
              )}
            </tbody>
          </table>
